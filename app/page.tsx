          ...
          <div className="frame-container  rounded-3xl flex fixed    w-[50%] z-50">
            ...
            <div className="image relative ">
              <Image
                src={dish1}
                alt="chef"
                className="fixed top-30 ml-50 rounded-full aspect-auto  bg-yellow-300 flex w-40 h-40 object-cover drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] "
              />
              <Image
                src={dish2}
                alt="chef"
                className="fixed top-20 ml-5  rounded-full aspect-auto  bg-yellow-300 flex w-40 h-40 object-cover drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] "
              />
              <Image
                src={dish3}
                alt="chef"
                className="fixed top-5 ml-30  rounded-full aspect-auto  bg-yellow-300 flex w-48 h-48 object-cover drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] "
              />
            </div>
          </div>
        </div>
